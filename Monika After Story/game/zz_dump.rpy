# --- FILE MAP ---
# zz_dump.rpy — аварийный дамп для отладки
#
# Вываливает внутренности (сколько топиков в пуле, флаги) в лог/файл.
# Не геймплей и почти не перевод. В game/dev/zz_dump.rpy — ещё один,
# чисто для разработчиков; этот живёт в релизе на всякий пожарный.
# ---
