...
init 5 python:
    addEvent(Event(persistent._mas_mood_database,eventlabel="mas_mood_inadequate",prompt="...свою никчемность.",category=[store.mas_moods.TYPE_BAD],unlocked=True),code="MOO")
