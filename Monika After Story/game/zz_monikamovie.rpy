# --- FILE MAP ---
# zz_monikamovie.rpy — кино вдвоём
#
# Label mas_monikamovie: сесть посмотреть видео/ролик. Не музыкальный
# селектор и не «спой песню». Диалоги вокруг просмотра — здесь,
# сами файлы роликов лежат в mod_assets.
# ---
